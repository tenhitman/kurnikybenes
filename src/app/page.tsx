...
const coop = {
  ...
  hint: "chicken coop",
  description:
    "Klasický design s dostatkem prostoru, ideální pro rostoucí hejno. Spojuje odolnost s okouzlujícím vzhledem, který doplní každou zahradu.",
  price: "od 12 499 Kč",
  specs: {
    ...
    features:
      "Vnější hnízdní box, 2 hřady, snadno čistitelný výsuvný tác, bezpečné západky, ventilační okno",
    gallery: [
...
const whyUsFeatures = [
  {
    ...
    description:
      "Vyrobeno z prémiového, povětrnostně odolného borového dřeva a pozinkované oceli, aby chránilo vaše hejno před predátory a živly.",
  },
  {
    icon: "Heart",
    title: "Spokojené slepice zaručeny",
    description:
      "Prostorný interiér s pohodlnými hřady a odlehlým hnízdním boxem poskytuje prostředí bez stresu pro snášení vajec.",
  },
  {
    icon: "Wrench",
    title: "Jednoduché pro vás",
    description:
      "Díky velkým dvířkům a rozebíratelnému snáškovému boxu z hygienických materiálů je údržba kurníku rychlá, jednoduchá a účinná.",
  },
];
...
const aboutMe = {
  name: "Kamil Beneš",
  title: "Řemeslník a chovatel",
  image: "/videos/images/Kamil.jpg",
...
const interactiveFeatures = [
  {
    ...
    description:
      "Zajišťuje optimální proudění vzduchu pro zdravé prostředí uvnitř kurníku.",
  },
  {
    id: 2,
    ...
    description:
      "Pohodlný a bezpečný sběr vajec bez nutnosti vstupovat do kurníku a rušit slepice.",
  },
  {
    id: 3,
    ...
    description:
      "Extrémně usnadňuje čištění. Stačí vysunout, vyčistit a zasunout zpět.",
  },
  {
    id: 4,
    ...
    description:
      "Robustní západky na všech dvířkách chrání vaše hejno před predátory.",
  },
];
...
const testimonials = [
  {
    quote:
      "Kurník je fantastický! Montáž byla snadná a naše slepice si ho okamžitě oblíbily. Je robustní a na naší zahradě vypadá skvěle.",
    author: "Emílie R.",
    location: "Lhota",
  },
  {
    quote:
      "Jsem tak ohromen kvalitou a designem. Snadno čistitelný tác je revoluční. Vřele doporučuji Kurníky Beneš!",
    author: "David L.",
    location: "Doubrava",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Náš kurník je navržen pro snadnou montáž. Ve dvou lidech to obvykle trvá 1-2 hodiny. Všechny součástky a podrobné pokyny jsou součástí balení.",
  },
  {
    question: "Je dřevo ošetřené?",
    answer:
      "Používáme vysoce kvalitní, odolné borové dřevo. I když je přirozeně odolné, doporučujeme každoročně aplikovat netoxický nátěr pro maximální prodloužení životnosti.",
  },
  {
    question: "Jaké jsou náklady na dopravu a doba doručení?",
    answer:
      "Nabízíme paušální dopravu po celé ČR. Doručení obvykle trvá 3-5 pracovních dnů. Po odeslání objednávky obdržíte sledovací číslo.",
  },
  {
    question: "Mohu si kurník přizpůsobit?",
    answer:
      "V současné době nabízíme Model Klasik pouze ve standardní konfiguraci, abychom zajistili kvalitu a rychlé dodání. Zkoumáme možnosti přizpůsobení do budoucna!",
  },
];
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 max-w-screen-2xl items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6 text-sm font-medium">
            ...
            <a href="#coop" className="transition-colors hover:text-primary">
              Kurník
            </a>
            <a
            ...
            <a href="#video" className="transition-colors hover:text-primary">
              Video
            </a>
      ...
      <main className="flex-1">
        <section className="relative h-[70vh] w-full">
          ...
          <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white p-4">
            ...
            <p className="mt-4 max-w-2xl text-lg text-primary-foreground/80">
              Objevte náš ručně vyráběný kurník, postavený s láskou, péčí a z
              nejlepších přírodních materiálů.
            </p>
        ...
        <section id="features" className="py-16 md:py-24 bg-background">
          <div className="container">
            ...
            <p className="mt-4 text-center text-lg text-muted-foreground max-w-2xl mx-auto">
              Stavíme kurníky s ohledem na tři věci: bezpečí vašeho hejna,
              jejich štěstí a váš klid.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-card p-8 rounded-lg shadow-lg">
                <h2 className="font-headline text-3xl md:text-4xl font-bold text-primary">
                  Kdo stojí za vaším kurníkem?
                </h2>
                <p className="mt-4 font-headline text-xl text-muted-foreground">
                  {aboutMe.name}, {aboutMe.title}
                </p>
                <p className="mt-6 text-muted-foreground">
                  Jmenuji se Kamil Beneš a chovu slepic se věnuji už od roku
                  2000. Od roku 2010 navíc chovám brojlery na maso, takže velmi
                  dobře vím, co slepice opravdu potřebují – i co chovatel ocení.
                  <br />
                  <br />
                  Proto jsem spojil svůj dlouholetý koníček s řemeslem – jsem
                  vyučený klempíř a celý život pracuji ve stavebnictví, hlavně s
                  kovem, plechem a svařováním. Z těchto zkušeností vznikl
                  projekt, kterému dnes věnuji veškerý svůj čas – výroba
                  poctivých plně automatických a bezúdržbových kurníků pro
                  slepice.
                  <br />
                  <br />
                  Každý kurník vyrábím ručně ve své dílně, kompletně sám, od
                  konstrukce až po finální montáž. Nosná konstrukce je
                  celosvařená z profilů a následně proveden žárový zinek, který
                  vydrží až 40 let. Stěny tvoří polyuretanové panely (PUR) –
                  lakovaný plech zvenku i zevnitř, žádné natírání, minimální
                  údržba.
                  <br />
                  <br />
                  Součástí každého kurníku jsou plně automatická dvířka, která
                  se samy zavírají i otvírají. Uvnitř na podlaze je voděodolná
                  překližka, velké snáškové hnízdo, bidla, propracovaný větrací
                  systém, a také krmný a napájecí systém, který je součástí
                  každého kurníku.
                  <br />
                  <br />
                  Nechybí ani popeliště a bidlo pod kurníkem, kde si slepice
                  rády posedí. Kurník má i držadla pro snadné přenášení, takže
                  se s ním dá pohodlně manipulovat.
                  <br />
                  <br />
                  Dodávám kompletní kurníky na klíč – plně vybavené, funkční a
                  připravené k okamžitému používání. Stačí postavit na místo a
                  můžete začít chovat.
                  <br />
                  <br />
                  Věřím, že poctivá práce a kvalitní materiály se vyplácí. Mým
                  cílem je vyrábět kurníky, které vydrží dlouhé roky bez oprav a
                  budou sloužit vám i slepicím s maximálním komfortem.{" "}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <div className="container">
            ...
            <p className="mt-4 text-center text-lg text-muted-foreground max-w-2xl mx-auto">
              Každý detail našeho kurníku je navržen s ohledem na pohodlí a
              bezpečí vašich slepic.
            </p>
              ...
              {detailedFeatures.map((feature) => (
                <div key={feature.title} className="flex gap-4">
                  <div className="flex-shrink-0">
                    {
                      detailedFeatureIcons[
                        feature.icon as keyof typeof detailedFeatureIcons
                      ]
                    }
                  </div>
                  <div>
        ...
        <section id="interactive" className="py-16 md:py-24 bg-background">
          <div className="container">
            <h2 className="text-center font-headline text-3xl md:text-4xl font-bold">
              Prozkoumejte každý detail
            </h2>
            <p className="mt-4 text-center text-lg text-muted-foreground max-w-2xl mx-auto">
              Kliknutím na jednotlivé body na obrázku zjistíte více o klíčových
              vlastnostech našeho kurníku.
            </p>
        ...
        <section id="video" className="py-16 md:py-24">
          <div className="container">
            ...
            <p className="mt-4 text-center text-lg text-muted-foreground max-w-2xl mx-auto">
              Projděte si s námi všechny detaily a přednosti našeho
              nejoblíbenějšího modelu.
            </p>
        ...
        <section
          id="testimonials"
          className={cn("py-16 md:py-24", "bg-wood-pattern")}
        >
          <div className="container">
            <h2 className="text-center font-headline text-3xl md:text-4xl font-bold">
            ...
            <p className="mt-4 text-center text-lg text-muted-foreground max-w-2xl mx-auto">
              Jsme hrdí na to, že máme šťastná hejna a ještě šťastnější
              majitele.
            </p>
        ...
        >
          <div className="container">
            ...
            <p className="mt-4 text-center text-lg text-muted-foreground max-w-2xl mx-auto">
              Máte dotazy nebo jste připraveni objednat? Rádi se vám budeme
              věnovat.
            </p>
